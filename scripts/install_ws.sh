...
sudo apt install ros-galactic-mavlink ros-galactic-geographic-msgs libgeographic-dev \
    ros-galactic-eigen-stl-containers ros-galactic-diagnostic-updater \
    ros-galactic-behaviortree-cpp-v3 ros-galactic-test-msgs ros-galactic-bondcpp \
    ros-galactic-ompl ros-galactic-xacro ros-galactic-gazebo-ros-pkgs \
    ros-galactic-nav2-bt-navigator ros-galactic-mavros ros-galactic-image-transport-plugins -y
